...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="/">
           ...
           <h3 class="mb-0" style="font-family: 'Poppins', sans-serif; font-weight: 700; letter-spacing: 1px; font-size: 32px;">
    <span style="color: rgb(197, 6, 250);">F</span><span class="shiny-text">inote</span>
</h3>
        </a>

        <div class="ms-auto">
<a href="/logout" class="btn btn-light btn-logout-custom rounded-pill px-4 py-1" style="font-weight: 600; color: rgb(197, 6, 250);">
     Logout
</a>
